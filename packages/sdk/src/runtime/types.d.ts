...
export interface PhonixRuntimeHttp {
     ...
     */
    GET(url: string, headers: Record<string, string>, callback: (response: string) => void): void;
    /**
     ...
     * @param callback  - Called with the response body as a string
     */
    POST(url: string, headers: Record<string, string>, body: string, callback: (response: string) => void): void;
}
export interface PhonixRuntimeWs {
     ...
     */
    open(url: string, options: Record<string, unknown>, onOpen: () => void, onMessage: (payload: string) => void, onError: (err: unknown) => void): void;
...
export interface IPhonixRuntime {
     ...
     */
    fulfill?(result: string, contentType: string, destinations: Record<string, unknown>, onSuccess: () => void, onError: (err: unknown) => void): void;
}

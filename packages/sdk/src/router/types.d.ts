...
export type RoutingStrategy = 'cost' | 'latency' | 'availability' | 'round-robin' | 'balanced';
...
export type RouterEventType = 'provider:selected' | 'provider:failed' | 'provider:recovered' | 'circuit:opened' | 'circuit:closed' | 'retry' | 'failover';
